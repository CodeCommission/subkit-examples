...
export const resolvers = {
  ...
  Mutation: {
    upsertTodo: (parent, args, context, info) => context.loaders.todosDB.put(Object.assign({}, args.input, {_id: args.input.id || uuid.v1(), _rev: args.input.rev}))
  ...
  Subscription: {
    onChangedTodo: (parent, args, context, info) => Object.assign({}, parent, {id: parent._id, rev: parent._rev}),
  }
}
